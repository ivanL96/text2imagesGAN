...
class GANTrainer(object):
    ...
    def sample(self, datapath, num_samples=25, stage=1, draw_bbox=True, max_objects=3):
        ...
        label_one_hot = torch.FloatTensor(num_embeddings, max_objects, 81).fill_(0)
        label_one_hot = label_one_hot.scatter_(2, _labels, 1).float()
        #######################################
        ...
        for count in range(num_samples):
            ...
            vutils.save_image(data_img, '{}/{}.png'.format(save_dir, captions_list[index].decode('utf-8')), normalize=True, nrow=5)
